...
static const uintptr_t NMPC_UAV_OBSTACLE_NUM_PARAMETERS = 1548;

/// Number of parameters associated with augmented Lagrangian
static const uintptr_t NMPC_UAV_OBSTACLE_N1 = 372;

/// Number of penalty constraints
static const uintptr_t NMPC_UAV_OBSTACLE_N2 = 0;
...
struct nmpc_uav_obstacleSolverStatus {
  ...
  double lagrange[NMPC_UAV_OBSTACLE_N1];
};
